...
mymainmenu = awful.menu({ items = { { "Awesome", myawesomemenu, beautiful.awesome_icon },
                                    { "Appearance Settings", function () awful.util.spawn("lxappearance") end },
				    { "Change Background", function () awful.util.spawn("nitrogen") end },
				    { "Display Settings", function () awful.util.spawn("arandr") end },
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "", "E", "D", "O", "R", "A" }, s, awful.layout.layouts[3])
    ...
    -- Create Net Speed Widget
    local net_speed_widget = require("awesome-wm-widgets.net-speed-widget.net-speed")
    
    -- Create Spotify widget
    local spotify_widget = require("awesome-wm-widgets.spotify-widget.spotify")
    
    -- Create GitHub Activity Widget
...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ "Control" }, "space", function () awful.util.spawn("rofi -show run") end,
    ...
    -- Thunderbird
    awful.key({ modkey }, "e", function () awful.util.spawn("flatpak run org.mozilla.Thunderbird") end,
              {description = "run thunderbird", group = "applications"}),
